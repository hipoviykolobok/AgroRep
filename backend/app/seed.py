...
def seed_database(db: Session) -> None:
    ...
    for name, object_type, description in [
        ...
        ("Пшеница озимая", "crop", "Озимая зерновая культура"),
        ("Пшеница яровая", "crop", "Яровая зерновая культура"),
        ("Зерновые культуры", "crop", "Группа зерновых культур"),
    ...
    for name, description in {
        ...
        "Валовой сбор": "Общий объем собранной продукции",
